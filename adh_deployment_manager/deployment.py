...
class Populator(CommandHandler):
    def __init__(self,
                 deployment,
                 location):
    ...
    def execute(self):
        ...
        for adh_query, analysis_query in queries:
            ...
            if query_output:
                analysis_query.dump(self.location)
...
class Fetcher(CommandHandler):
    def __init__(self,
                 deployment,
                 location, file_name=None, extension=".sql"):
        self.deployment = deployment
        self.location = location
    ...
    def execute(self):
        ...
        for _, analysis_query in queries:
                analysis_query.dump(self.location, self.file_name, self.extension)

class Deployer(CommandHandler):
    def __init__(self,
                 deployment):
       self.deployment = deployment
